...
export default function Services() {
  ...
  return (
    <section id="services" className="py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-[oklch(0.75_0.18_50)/5] rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none" style={{ transform: 'translate(-50%, -50%) translateZ(0)', contain: 'strict' }} />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-[oklch(0.75_0.18_50)/5] rounded-full blur-3xl translate-x-1/2 translate-y-1/2 pointer-events-none" style={{ transform: 'translate(50%, 50%) translateZ(0)', contain: 'strict' }} />
