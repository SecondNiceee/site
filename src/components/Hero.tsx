      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-24 pb-16">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <span className="w-2 h-2 rounded-full bg-[oklch(0.75_0.18_50)] animate-[softGlow_8s_ease-in-out_infinite] pointer-events-none" style={{ willChange: 'opacity, box-shadow' }} />
