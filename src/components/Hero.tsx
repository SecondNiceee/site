...
export default function Hero() {
  ...
  const statsRef = useRevealChildren<HTMLDivElement>(100);
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 lg:px-8 pt-24 pb-16">
        <div className="max-w-5xl mx-auto text-center">
          {/* Badge */}
          <div className="reveal fade-up is-visible inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[oklch(0.75_0.18_50)/30] bg-[oklch(0.75_0.18_50)/10] text-sm text-[oklch(0.75_0.18_50)] mb-8" style={{ animationDelay: "0ms" }}>
          ...
          {/* Main Heading */}
          <h1
            className="reveal fade-up is-visible font-[var(--font-oswald)] text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold uppercase leading-[0.95] tracking-tight mb-6"
          ...
          {/* Subtitle */}
          <p
            className="reveal fade-up is-visible text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10"
          ...
          {/* CTA Buttons */}
          <div
            className="reveal fade-up is-visible flex flex-col sm:flex-row gap-4 justify-center items-center mb-16"
          ...
          >
            {stats.map((stat) => (
              <div
                key={stat.label}
                className="reveal fade-up flex flex-col items-center p-6 rounded-2xl glass"
              >
