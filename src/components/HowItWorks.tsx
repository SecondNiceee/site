...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="py-24 md:py-32 relative overflow-hidden bg-secondary/30">
      ...
      {/* Orange accent glow */}
      <div
        className="absolute top-0 left-1/2 w-[600px] h-[300px] bg-[oklch(0.75_0.18_50)/8] dark:bg-[oklch(0.75_0.18_50)/5] rounded-full blur-3xl pointer-events-none"
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        {/* CTA */}
        <AnimateOnScroll direction="up" delay={0.3} className="text-center mt-16">
