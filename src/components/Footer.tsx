            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center hover:bg-[oklch(0.75_0.18_50)] hover:text-black transition-colors duration-300 hover:scale-110 active:scale-95"
                  title={social.name}
                  style={{ transition: 'background-color 0.3s, color 0.3s, transform 0.15s' }}
                >
      ...
      <div className="border-t border-border">
        <div className="container mx-auto px-4 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <button
              onClick={scrollToTop}
              className="flex items-center gap-2 text-sm text-muted-foreground hover:text-[oklch(0.75_0.18_50)] transition-colors duration-300 hover:-translate-y-0.5"
              style={{ transition: 'color 0.3s, transform 0.15s' }}
            >
              Наверх
